...
lastReviewedNote: 'Reviewed Skills #118 exact Foundry 0.1.13 lock, multi-Process interaction and data #33 separation; CLI wrapper and ownership boundaries remain unchanged.'
related:
  - AGENTS.md
  - .docpact/config.yaml
