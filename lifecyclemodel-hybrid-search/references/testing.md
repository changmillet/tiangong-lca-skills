...
```bash
pnpm dlx --package=@tiangong-lca/cli@0.1.16 tiangong-lca auth doctor-auth --json
...
```bash
pnpm dlx --package=@tiangong-lca/cli@0.1.16 tiangong-lca search lifecyclemodel --input ./assets/example-request.json --dry-run --json
```
